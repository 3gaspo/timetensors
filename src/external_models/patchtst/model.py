"""Source-adapted PatchTST forecasting architecture and local tensor wrapper.

Adapted from `yuqinie98/PatchTST` revision
`204c21efe0b39603ad6e2ca640ef5896646ab1a9`. The pretraining paths and
internal RevIN layer are omitted; TimeTensors owns normalization externally.
"""
